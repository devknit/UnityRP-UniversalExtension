...
{
	[DisallowMultipleRendererFeature( "Speed Line")]
	internal sealed class SpeedLine : ScriptableRendererFeature
	{
		public override void Create()
		{
			...
			{
                m_Pass = new SpeedLinePass( m_Material)
                {
